try {
  (() => {
    ...
    var Ol = v(zt);
    function jt(e, t) {
      return t === 'transparent' ? t : C(_({}, A(t), { lightness: parseFloat(e) }));
    }
    var _l = v(jt);
    function kt(e, t) {
      return t === 'transparent' ? t : C(_({}, A(t), { saturation: parseFloat(e) }));
    }
    var Tl = v(kt);
    function Gt(e, t) {
    ...
    function Vt(e, t) {
      ...
      var r = I(t),
        n = typeof r.alpha == 'number' ? r.alpha : 1,
        a = _({}, r, { alpha: D(0, 1, +(n * 100 - parseFloat(e) * 100).toFixed(2) / 100) });
      return $(a);
    }
    var Rl = v(Vt);
    var $t = 'actions',
    ...
    var Er = ({ rows: e, columns: t, rowsData: r }) => {
      ...
      Nr = (e) => o.createElement(ot, { nodeRenderer: Cr, dataIterator: wr, ...e }),
      xr = de(Nr),
      Lr = er(nr()),
      ...
      Hr = ({ actions: e, onClear: t }) => {
        ...
        return (
          ...
          o.createElement(
            ...
            o.createElement(Ne, { actionItems: [{ title: 'Clear', onClick: t }] }),
          )
        );
      },
      Ur = (e, t) => {
          ...
          (super(e),
            ...
            (this.addAction = (t) => {
              this.setState((r) => {
                ...
                return (
                  a && Ur(a.data, t.data) ? a.count++ : ((t.count = 1), n.push(t)),
