import { _ as nt, a as K, c as Mr, d as gi, b as yn } from './chunk-XP5HYGXS-BHXC9YeQ.js';
import {
  c as Di,
  n as Ai,
  y as Ci,
  ...
  a as Dt,
  Y as Ur,
} from './index-DcVEtX0K.js';
import { r as Ge, R as ft } from './index-Dq4ZvVuH.js';
...
var Si = K({
    ...
    '../../node_modules/estraverse/estraverse.js'(e) {
      (function t(r) {
        ...
        function m(F) {
          ...
          for (v in F)
            F.hasOwnProperty(v) &&
              ((B = F[v]), typeof B == 'object' && B !== null ? (y[v] = m(B)) : (y[v] = B));
          return y;
        }
        function g(F, y) {
          var v, B, T, j;
          for (B = F.length, T = 0; B;)
            ((v = B >>> 1), (j = T + v), y(F[j]) ? (B = v) : ((T = j + 1), (B -= v + 1)));
          return T;
        }
        ((n = {
        ...
        ((C.prototype.path = function () {
          ...
          (C.prototype.__execute = function (F, y) {
            ...
            return (
              ...
              (this.__current = y),
              (this.__state = null),
              F && (B = F.call(this, y.node, this.__leavelist[this.__leavelist.length - 1].node)),
              (this.__current = v),
              B
            );
          }),
        ...
        function E(F, y) {
          return (F === n.ObjectExpression || F === n.ObjectPattern) && y === 'properties';
        }
        function w(F, y) {
          for (var v = F.length - 1; v >= 0; --v) if (F[v].node === y) return !0;
          return !1;
        }
        ((C.prototype.traverse = function (F, y) {
          var v, B, T, j, M, V, U, H, ne, se, ue, Z;
          for (
            ...
            if (((T = v.pop()), T === Z)) {
              if (((T = B.pop()), (V = this.__execute(y.leave, T)), this.__state === u || V === u))
                return;
              continue;
            }
            if (T.node) {
              if (((V = this.__execute(y.enter, T)), this.__state === u || V === u)) return;
              if ((v.push(Z), B.push(T), this.__state === h || V === h)) continue;
              if (((j = T.node), (M = j.type || T.wrap), (se = this.__keys[M]), !se))
                ...
                if (((U = se[H]), (ue = j[U]), !!ue)) {
                  if (Array.isArray(ue)) {
                    for (ne = ue.length; (ne -= 1) >= 0;)
                      if (ue[ne] && !w(B, ue[ne])) {
                        if (E(M, se[H])) T = new A(ue[ne], [U, ne], 'Property', null);
                        else if (D(ue[ne])) T = new A(ue[ne], [U, ne], null, null);
                        else continue;
                        v.push(T);
                      }
                  } else if (D(ue)) {
          ...
          (C.prototype.replace = function (F, y) {
            var v, B, T, j, M, V, U, H, ne, se, ue, Z, we;
            function st(Re) {
              var R, Je, je, ut;
              if (Re.ref.remove()) {
            ...
            for (
              this.__initialize(F, y),
                ...
                B = this.__leavelist,
                Z = { root: F },
                V = new A(F, null, null, new x(Z, 'root')),
                v.push(V),
                B.push(V);
              v.length;
            ) {
              ...
              if (
                ...
                return Z.root;
              if (
                ((T = V.node), !!T && (v.push(ue), B.push(V), !(this.__state === h || M === h)))
              ) {
                ...
                for (U = ne.length; (U -= 1) >= 0;)
                  if (((we = ne[U]), (se = T[we]), !!se))
                    if (Array.isArray(se)) {
                      for (H = se.length; (H -= 1) >= 0;)
                        if (se[H]) {
                          if (E(j, ne[U])) V = new A(se[H], [we, H], 'Property', new x(se, H));
                          else if (D(se[H])) V = new A(se[H], [we, H], null, new x(se, H));
                          else continue;
                          v.push(V);
                        }
        ...
        function _(F, y, v) {
          var B = [],
            ...
            M,
            V;
          if (!F.range) throw new Error('attachComments needs range information');
          if (!v.length) {
            if (y.length) {
      ...
      ((e.encode = function (p) {
        ...
        (e.decode = function (p, m, g) {
          var x = p.length,
            ...
            E;
          do {
            if (m >= x) throw new Error('Expected more digits in base 64 VLQ value.');
  ...
  At = K({
    '../../node_modules/escodegen/node_modules/source-map/lib/util.js'(e) {
      ...
      function s(_) {
        var F = _.match(r);
        return F ? { scheme: F[1], auth: F[2], host: F[3], port: F[4], path: F[5] } : null;
      }
      e.urlParse = s;
      function o(_) {
        var F = '';
      ...
      function u(_) {
        ...
        for (var v = e.isAbsolute(F), B = F.split(/\/+/), T, j = 0, M = B.length - 1; M >= 0; M--)
          ((T = B[M]),
            T === '.'
              ? B.splice(M, 1)
              : T === '..'
                ? j++
                : j > 0 && (T === '' ? (B.splice(M + 1, j), (j = 0)) : (B.splice(M, 2), j--)));
        return ((F = B.join('/')), F === '' && (F = v ? '/' : '.'), y ? ((y.path = F), o(y)) : F);
      }
      e.normalize = u;
      function h(_, F) {
        (_ === '' && (_ = '.'), F === '' && (F = '.'));
      ...
      function p(_, F) {
        ...
        for (var y = 0; F.indexOf(_ + '/') !== 0;) {
          var v = _.lastIndexOf('/');
          if (v < 0 || ((_ = _.slice(0, v)), _.match(/^([^\/]+:\/)?\/*$/))) return F;
          ++y;
        }
      ...
      function n(s, o, u, h) {
        if (u < h) {
          var p = r(u, h),
            m = u - 1;
          t(s, p, h);
          for (var g = s[h], x = u; x < h; x++) o(s[x], g) <= 0 && ((m += 1), t(s, m, x));
          t(s, m + 1, x);
          var A = m + 1;
  ...
  Mi = K({
    '../../node_modules/escodegen/node_modules/source-map/lib/source-map-consumer.js'(e) {
      ...
      ((u.fromSourceMap = function (g, x) {
        ...
        (u.prototype._charIsMappingSeparator = function (g, x) {
          var A = g.charAt(x);
          return A === ';' || A === ',';
        }),
        ...
        (u.prototype.allGeneratedPositionsFor = function (g) {
          ...
          if (D >= 0) {
            ...
            if (g.column === void 0)
              ...
              for (var b = E.originalColumn; E && E.originalLine === x && E.originalColumn == b;)
                (C.push({
                  line: t.getArg(E, 'generatedLine', null),
                  column: t.getArg(E, 'generatedColumn', null),
                  lastColumn: t.getArg(E, 'lastGeneratedColumn', null),
      ...
      function h(g, x) {
        ...
        (w && (w = t.normalize(w)),
          ...
          (this._absoluteSources = this._sources.toArray().map(function (_) {
            return t.computeSourceURL(w, _, x);
          })),
          (this.sourceRoot = w),
      ...
      ((h.prototype = Object.create(u.prototype)),
        ...
        (h.prototype._findSourceIndex = function (g) {
          var x = g;
          if (
            (this.sourceRoot != null && (x = t.relative(this.sourceRoot, x)), this._sources.has(x))
          )
        ...
        (h.fromSourceMap = function (g, x) {
          ...
          ((A.sourceRoot = g._sourceRoot),
            ...
            (A._absoluteSources = A._sources.toArray().map(function (y) {
              return t.computeSourceURL(A.sourceRoot, y, x);
            })));
          for (
      ...
      ((h.prototype._parseMappings = function (g, x) {
        for (
          ...
          if (g.charAt(L) === ';') (A++, L++, (C = 0));
            ...
            if (((T = g.slice(L, M)), (j = _[T]), j)) L += T.length;
              ...
              for (j = []; L < M;) (s.decode(g, L, F), (V = F.value), (L = F.rest), j.push(V));
        ...
        (h.prototype._findMapping = function (g, x, A, C, D, E) {
          if (g[A] <= 0)
        ...
        (h.prototype.originalPositionFor = function (g) {
          var x = { generatedLine: t.getArg(g, 'line'), generatedColumn: t.getArg(g, 'column') },
            A = this._findMapping(
              x,
      ...
      ((m.prototype = Object.create(u.prototype)),
        ...
        Object.defineProperty(m.prototype, 'sources', {
          get: function () {
            for (var g = [], x = 0; x < this._sections.length; x++)
              for (var A = 0; A < this._sections[x].consumer.sources.length; A++)
        ...
        (m.prototype.originalPositionFor = function (g) {
          var x = { generatedLine: t.getArg(g, 'line'), generatedColumn: t.getArg(g, 'column') },
            A = r.search(x, this._sections, function (D, E) {
            ...
            this.walk(function (E, w) {
              ((p.code += E),
                w.source !== null && w.line !== null && w.column !== null
                  ? ((x !== w.source || A !== w.line || C !== w.column || D !== w.name) &&
                      m.addMapping({
                        source: w.source,
  ...
  Wi = K({
    '../../node_modules/escodegen/escodegen.js'(e) {
      (function () {
        var t, r, n, s, o, u, h, p, m, g, x, A, C, D, E, w, b, S, L, _, F, y, v, B, T, j;
...
`,
        ...
        function ui(i) {
          ...
          if (((a = i.toString()), i.source)) {
            ...
            for (c = l[1], a = '', P = !1, O = !1, d = 0, k = i.source.length; d < k; ++d)
              ((I = i.source.charCodeAt(d)),
                O
                  ? ((a += Pr(I, O)), (O = !1))
                  : (P ? I === 93 && (P = !1) : I === 47 ? (a += '\\') : I === 91 && (P = !0),
                    (a += Pr(I, O)),
                    (O = I === 92)));
            return '/' + a + '/' + c;
          }
        ...
        function ci(i) {
          ...
          if (
            ((P = !(A === 'double' || (A === 'auto' && I < k))), (O = P ? "'" : '"'), !(P ? k : I))
          )
            return O + l + O;
        ...
        function Tr(i) {
          var l,
            ...
            c,
            d = '';
          for (l = 0, a = i.length; l < a; ++l) ((c = i[l]), (d += Array.isArray(c) ? Tr(c) : c));
          return d;
        }
        function Y(i, l) {
        ...
        function pi(i, l) {
          var a, c, d, k, I, P, O, J;
          for (a = i.split(/\r\n|[\r\n]/), P = Number.MAX_VALUE, c = 1, d = a.length; c < d; ++c) {
          ...
          for (
            ...
            ((J = Y(fe(a[c].slice(P)))), (a[c] = y ? J.join('') : J));
          return (
            (h = O),
            a.join(`
`)
...
`),
        ...
        function Nr(i, l) {
          var a, c, d, k, I, P, O, J, ce, Ve, He, Rr, jr, ve;
...
` && (d = ['{']),
                      d.push(c)));
                  var I, P, O, J;
                  for (J = re, l & se && (J |= ue), I = 0, P = i.body.length; I < P; ++I)
                    (B &&
                      (I === 0 &&
...
` && (d = ['{'])),
                      ...
                      (i.specifiers.length === 0
                        ...
                        : i.specifiers[0].type === t.ExportBatchSpecifier
                          ...
                          : ((a = W(a, '{')),
                            ae(function (k) {
                              var I, P;
                              for (a.push(D), I = 0, P = i.specifiers.length; I < P; ++I)
                                (a.push(k),
            ...
            ExpressionStatement: function (i, l) {
              ...
              function I(P) {
                var O, J, ce;
                if (P.slice(0, 5) !== 'async' || !u.code.isWhiteSpace(P.charCodeAt(5))) return !1;
                for (J = 6, ce = P.length; J < ce && u.code.isWhiteSpace(P.charCodeAt(J)); ++J);
                return J === ce || P.slice(J, J + 8) !== 'function'
                  ? !1
                  : ((O = P.charCodeAt(J + 8)),
                    O === 40 || u.code.isWhiteSpace(O) || O === 42 || u.code.isLineTerminator(O));
              }
                    ...
                    i.specifiers[c].type === t.ImportNamespaceSpecifier
                      ...
                      : (a.push(E + '{'),
                        i.specifiers.length - c === 1
                          ...
                          : (ae(function (k) {
                              var I, P;
                              for (a.push(D), I = c, P = i.specifiers.length; I < P; ++I)
                                (a.push(k),
                                  a.push(d.generateExpression(i.specifiers[I], r.Sequence, R)),
                                  I + 1 < P && a.push(',' + D));
                            }),
            ...
            SwitchStatement: function (i, l) {
              ...
              if (
                (ae(function () {
                  a = [
                    'switch' + E + '(',
                    P.generateExpression(i.discriminant, r.Sequence, R),
                    ')' + E + '{' + D,
                  ];
                }),
                i.cases)
            ...
            SwitchCase: function (i, l) {
              ...
              return (
                ae(function () {
                  for (
                    i.test
                      ? (a = [W('case', P.generateExpression(i.test, r.Sequence, R)), ':'])
                      : (a = ['default:']),
                      d = 0,
                      k = i.consequent.length,
                      k &&
                        i.consequent[0].type === t.BlockStatement &&
                        ((c = P.maybeBlock(i.consequent[0], re)), a.push(c), (d = 1)),
                    ...
                    (d === k - 1 && l & Z && (I |= Z),
                      (c = fe(P.generateStatement(i.consequent[d], I))),
                      a.push(c),
          ...
          (oe.Expression = {
            ...
            BinaryExpression: function (i, l, a) {
              ...
              return (
                ...
                (i.operator.slice(-1) === '<' && P.toString().slice(0, 3) === '!--')
                  ? (c.push(pe()), c.push(P))
                  : (c = W(c, P)),
                i.operator === 'in' && !(a & U)
                  ? ['(', c, ')']
                  ...
                  : ((c = [i.operator]),
                    i.operator.length > 2
                      ...
                      : ((I = Y(c).toString()),
                        ...
                        (((P === 43 || P === 45) && P === k) ||
                          (u.code.isIdentifierPartES5(P) && u.code.isIdentifierPartES5(k))) &&
                          c.push(pe()),
                        c.push(d))),
                le(c, r.Unary, l)
              );
            ...
            ObjectPattern: function (i, l, a) {
              ...
              if (((I = !1), i.properties.length === 1))
                ((P = i.properties[0]),
                  P.type === t.Property && P.value.type !== t.Identifier && (I = !0));
              else
                for (d = 0, k = i.properties.length; d < k; ++d)
                  if (((P = i.properties[d]), P.type === t.Property && !P.shorthand)) {
                    I = !0;
                    break;
                  }
              return (
            ...
            Literal: function (i, l, a) {
              ...
              if (i.hasOwnProperty('raw') && F && _.raw)
                try {
                  if (
                    ((c = F(i.raw).body[0].expression), c.type === t.Literal && c.value === i.value)
                  )
                    return i.raw;
                } catch {}
              return i.regex
                ...
                i.blocks &&
                  ae(function () {
                    for (d = 0, k = i.blocks.length; d < k; ++d)
                      ((I = P.generateExpression(i.blocks[d], r.Sequence, R)),
...
`,
        ...
        (z.parseForStatement = function (e) {
          ...
          var t =
            ...
            this.eatContextual('await')
              ...
              : -1;
          if (
            (this.labels.push(Pt), this.enterScope(0), this.expect(f.parenL), this.type === f.semi)
          )
        ...
        (z.parseFunctionStatement = function (e, t, r) {
          return (this.next(), this.parseFunction(e, Ye | (r ? 0 : Tt), !1, t));
        }),
        ...
        ($.readWord1 = function () {
          ...
          for (
            ...
            if (qe(s, n)) this.pos += s <= 65535 ? 1 : 2;
              ...
              ((t ? Pe : qe)(u, n) || this.invalidStringToken(o, 'Invalid Unicode escape'),
                (e += Ut(u)),
                (r = this.pos));
            } else break;
            t = !1;
...
`))
          ...
          jsx_parseOpeningElementAt(y, v) {
            ...
            for (T && (B.name = T); this.type !== C.slash && this.type !== D.jsxTagEnd;)
        ...
        r =
          ...
          function () {
            ...
            for (var x = Array(p), A = 0, m = 0; m < g; m++)
              for (var C = arguments[m], D = 0, E = C.length; D < E; D++, A++) x[A] = C[D];
            return x;
          };
  ...
  var s = n.reduce(function (h, p) {
    ...
    return m
      ? h.concat(
          m.map(function (g) {
            var x, A;
            return (A = (x = g.match(/[\t ]/g)) === null || x === void 0 ? void 0 : x.length) !==
              null && A !== void 0
              ? A
              : 0;
          }),
...
function Ps(e) {
  ...
  if (Object.prototype.toString.call(e) !== '[object Object]') {
    ...
    return r == null || !Object.getOwnPropertyDescriptor(e, Symbol.toStringTag)?.writable
      ? !1
      : e.toString() === `[object ${r}]`;
  }
  let t = e;
    ...
    return (
      m && x === '{false}' && !n
        ...
        : m && x === '{true}'
          ...
          : ((A += ''.concat(e, '=').concat(x)), (C += ''.concat(e, '=').concat(x))),
...
`,
          ...
          .map(function (u, h) {
            return h === 0 ? u : ''.concat(Te(n, o)).concat(u);
          }).join(`
`)
      : t;
  },
  ...
  $n = function (e, t, r, n, s) {
    return s ? Te(r, n).length + t.length > s : e.length > 1;
  },
  ...
  Jn = function (e, t, r, n) {
    ...
    if (
      (v.forEach(function (T) {
        var j = Zs(T, Object.keys(m).includes(T), m[T], Object.keys(x).includes(T), x[T], t, r, n),
...
var Mu = (e, { name: t, type: r }) => {
    let n = r?.summary === 'element' || r?.summary === 'elementType',
      s = Qn(e, t);
    if (s != null) {
      if (n) return ee(jt(s));
...
`,
  ...
  ti = (e, t) => {
    ...
    _i(() => {
      if (!n) {
        let { id: g, unmappedArgs: x } = t;
        r.emit(Ci, { id: g, source: s, args: x });
      }
    });
    let o = e();
    if (n) return o;
    let u = { ...Ku, ...(t?.parameters.jsx || {}) },
      h = t?.parameters.docs?.source?.excludeDecorators ? t.originalStoryFn(t.args, t) : o,
      p = ei(h),
      m = Yu(p, u);
    return (m && (s = m), o);
  },
