    ...
    if (typeof y != 'string' && !Array.isArray(y)) {
      for (const d in y)
        if (d !== 'default' && !(d in p)) {
          ...
          m && Object.defineProperty(p, d, m.get ? m : { enumerable: !0, get: () => y[d] });
        }
    }
  }
...
function ee() {
  ...
  var x = {
    ...
    P = {};
  function _(e, t, n) {
    ((this.props = e), (this.context = t), (this.refs = P), (this.updater = n || x));
  }
  ...
  ((k.constructor = b), O(k, _.prototype), (k.isPureReactComponent = !0));
  var q = Array.isArray,
  ...
  function S(e, t, n, u, o) {
    ...
    if (((s = 0), (u = u === '' ? '.' : u + ':'), q(e)))
      ...
      for (e = i.call(e), f = 0; !(c = e.next()).done;)
        ((c = c.value), (i = u + $(c, f++)), (s += S(c, t, n, i, o)));
    else if (c === 'object')
      throw (
        (t = String(e)),
        Error(
  ...
  var l = { current: null },
    E = { transition: null },
    X = { ReactCurrentDispatcher: l, ReactCurrentBatchConfig: E, ReactCurrentOwner: w };
  function F() {
  ...
  return (
    ...
    (r.cloneElement = function (e, t, n) {
      ...
      if (t != null) {
        if (
          (t.ref !== void 0 && ((c = t.ref), (s = w.current)),
...
var L;
function te() {
  return (L || ((L = 1), (j.exports = ee())), j.exports);
}
var M = te();
const re = Y(M),
  oe = Z({ __proto__: null, default: re }, [M]);
export { re as R, te as a, oe as o, M as r };
